 ...
 * a mind map, flashcards, a practice quiz or slides. Each tool is an ordinary message to MoeAI, so the result
 * lands in the chat, grounded in the course material, and can be followed up.
 */
import React from 'react';
import { ScrollView, StyleSheet, Text, View, useWindowDimensions } from 'react-native';
import { AcademicCapIcon, DocumentTextIcon, PresentationChartBarIcon, RectangleStackIcon, ShareIcon } from 'react-native-heroicons/outline';
...
/** A row of Studio tools; `onPick(text, { studio })` sends the request. */
