...
export default function HomeScreen({ registerCurrentWeekReset, active = false, onOpenSettings }) {
  ...
  const { chats, startChat, sendMessage, renameChat, togglePinChat, removeLectureChats, removeSubjectChats } = useLectureChatStore();
