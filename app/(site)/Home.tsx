    ...
    <>
      ...
      <div className="modal-overlay" id="loginModal" role="dialog" aria-modal="true" aria-labelledby="loginTitle">
        <div className="modal-box lg lg-panel">
          ...
          <button className="m-btn-google" onClick={legacyHandler("showToast('\ud83d\udd11 Google sign-in \u2014 connect to Supabase')")}>
          ...
          <button className="m-btn m-btn-fire" onClick={legacyHandler("showToast('\ud83d\udd11 Login demo \u2014 connect to Supabase'); closeModal('loginModal')")}>
            Log In
          </button>
      ...
      <div className="modal-overlay" id="signupModal" role="dialog" aria-modal="true" aria-labelledby="signupTitle">
        <div className="modal-box lg lg-panel">
          ...
          <button className="m-btn m-btn-fire" onClick={legacyHandler("showToast('\u2705 Signup demo \u2014 connect to Supabase'); closeModal('signupModal')")}>
            Create Account
          </button>
